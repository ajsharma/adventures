...
class MomentsControllerTest < ActionController::TestCase
  ...
  test "should create moment" do
    assert_difference('Moment.count') do
      post :create, moment: { description: @moment.description, name: @moment.name, token: @moment.token, trash: @moment.trash }
    end
  ...
  test "should update moment" do
    put :update, id: @moment, moment: { description: @moment.description, name: @moment.name, token: @moment.token, trash: @moment.trash }
    assert_redirected_to moment_path(assigns(:moment))
  end
